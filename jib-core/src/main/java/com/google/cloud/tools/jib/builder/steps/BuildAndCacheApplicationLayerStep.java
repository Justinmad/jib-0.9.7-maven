...
class BuildAndCacheApplicationLayerStep
  ...
  static ImmutableList<BuildAndCacheApplicationLayerStep> makeList(
    ...
    try (Timer ignored = new Timer(buildConfiguration.getBuildLogger(), DESCRIPTION)) {
      ImmutableList.Builder<BuildAndCacheApplicationLayerStep> buildLayerStepsBuilder;
              if("war".equalsIgnoreCase(buildConfiguration.getPackaging())){
                buildLayerStepsBuilder = getWarBuildAndCacheApplicationLayerStepBuilder(listeningExecutorService, buildConfiguration, sourceFilesConfiguration, cache);
              } else {
                buildLayerStepsBuilder = getJarBuildAndCacheApplicationLayerStepBuilder(listeningExecutorService, buildConfiguration, sourceFilesConfiguration, cache);
              }
  ...
  private static ImmutableList.Builder<BuildAndCacheApplicationLayerStep> getWarBuildAndCacheApplicationLayerStepBuilder(ListeningExecutorService listeningExecutorService, BuildConfiguration buildConfiguration, SourceFilesConfiguration sourceFilesConfiguration, Cache cache) {
    ImmutableList.Builder<BuildAndCacheApplicationLayerStep> buildLayerStepsBuilder =
            ImmutableList.<BuildAndCacheApplicationLayerStep>builder()
                            ...
                            new BuildAndCacheApplicationLayerStep(
                                    ...
                                    LayerConfiguration.builder()
                                            .addEntry(
                                                    ...
                                                    sourceFilesConfiguration.getWebappDependenciesPathOnImage())
                                            .build(),
                                    cache))
                    .add(
                            new BuildAndCacheApplicationLayerStep(
                                    ...
                                    LayerConfiguration.builder()
                                            .addEntry(
                                                    ...
                                                    sourceFilesConfiguration.getWebappResourcesPathOnImage())
                                            .build(),
                                    cache))
                    .add(
                            new BuildAndCacheApplicationLayerStep(
                                    ...
                                    LayerConfiguration.builder()
                                            .addEntry(
                                                    ...
                                                    sourceFilesConfiguration.getWebappClassesPathOnImage())
                                            .build(),
                                    cache))
                    .add
                            (new BuildAndCacheApplicationLayerStep(
                            ...
                            LayerConfiguration.builder()
                                            .addEntry(
                                                    sourceFilesConfiguration.getWebappFiles(),
                                                    sourceFilesConfiguration.getWebappPathOnImage()
                                            )
                                            .build(),
                            cache
                    )).add(
                    ...
                    "WEB-INF",
                            ...
                            LayerConfiguration.builder()
                            .addEntry(
                                    sourceFilesConfiguration.getWebInfFiles(),
                                    sourceFilesConfiguration.getWebappWebInfPathOnImage()
                            )
                            .build(),
                    cache)));
    ...
    return buildLayerStepsBuilder;
  }

  private static ImmutableList.Builder<BuildAndCacheApplicationLayerStep> getJarBuildAndCacheApplicationLayerStepBuilder(ListeningExecutorService listeningExecutorService, BuildConfiguration buildConfiguration, SourceFilesConfiguration sourceFilesConfiguration, Cache cache) {
    ImmutableList.Builder<BuildAndCacheApplicationLayerStep> buildLayerStepsBuilder =
        ImmutableList.<BuildAndCacheApplicationLayerStep>builder()
            .add(
                new BuildAndCacheApplicationLayerStep(
