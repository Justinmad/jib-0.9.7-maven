...
public class DockerContextGenerator {
  ...
  public DockerContextGenerator setPackaging(String packaging) {
  ...
  public void generate(Path targetDirectory) throws IOException {
    ...
    if("WAR".equalsIgnoreCase(packaging)) {
      Path webappDir = targetDirectory.resolve("webapp");
      Files.createDirectory(webappDir);
      FileOperations.copy(sourceFilesConfiguration.getWebappFiles(), webappDir);
      Path webInfo = targetDirectory.resolve("WEB-INF");
      Files.createDirectory(webInfo);
      FileOperations.copy(sourceFilesConfiguration.getWebInfFiles(), webInfo);
    }
  ...
  String makeDockerfile() throws JsonProcessingException {
    ...
    if("WAR".equalsIgnoreCase(packaging)) {
      dockerfile
              ...
              .append("\n\nCOPY libs ")
              .append(sourceFilesConfiguration.getWebappDependenciesPathOnImage())
              .append("\nCOPY snapshot-libs ")
              .append(sourceFilesConfiguration.getWebappDependenciesPathOnImage())
              .append("\nCOPY resources ")
              .append(sourceFilesConfiguration.getWebappResourcesPathOnImage())
              .append("\nCOPY classes ")
              .append(sourceFilesConfiguration.getWebappClassesPathOnImage())
              .append("\nCOPY webapp ")
              .append(sourceFilesConfiguration.getWebappPathOnImage())
              .append("\n");
    }else {
      dockerfile
              .append("FROM ")
              ...
              .append("\nCOPY snapshot-libs ")
              .append(sourceFilesConfiguration.getDependenciesPathOnImage())
              .append("\nCOPY resources Container entrypoint set to")
