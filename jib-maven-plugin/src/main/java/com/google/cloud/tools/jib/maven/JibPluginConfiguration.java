...
abstract class JibPluginConfiguration extends AbstractMojo {
  ...
  private static final String DEFAULT_REGISTRY = "registry.cn-hangzhou.aliyuncs.com/z-young/";

  @Parameter(defaultValue = DEFAULT_REGISTRY + "${project.name}")
  @Nullable
  private String defaultToImage;
  ...
  String getBaseImage() {
    ...
    if ("war".equalsIgnoreCase(getProject().getPackaging())) {
      return DEFAULT_REGISTRY + "tomcat8";
    } else {
      return "openjdk:8";
    }
  }
